...
public:
	...
	// アウトライン描画設定
	void SetEnableOutLineDraw(const bool enamleOutLineDraw)
	{
		if (m_cb0_Obj.Work().EnableOutLineDraw != static_cast<int>(enamleOutLineDraw))
		{
			m_cb0_Obj.Work().EnableOutLineDraw = enamleOutLineDraw;
			m_dirtyCBObj = true;
		}
	}
